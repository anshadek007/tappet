            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form class="" id="add_custom_form" novalidate="" action="{{route("categories.update",$category->c_id)}}" enctype="multipart/form-data" method="POST">
                            @csrf
                                ...
                                <div class="col-sm-12">
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <img alt="img" src="{{getPhotoURL('categories',$category->c_id,$category->c_image)}}" class="rounded-circle mr-1" height="100" width="100">
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <img alt="img" src="{{getPhotoURL('categories',$category->c_id,$category->c_trans_image)}}" class="rounded-circle mr-1" height="100" width="100" style="background-color:#888;border-radius: 50%;">
                                        </div>

                                        <div class="col-sm-6 form-group">
                                            <label for="category_name">Category Name</label>
                                            <input type="text" value="{{ $category->c_name }}" placeholder="Enter category Name" name="category_name" class="form-control required" required="" maxlength="100" id="category_name">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <div class="input-group colorpickerinput">
                                                <input type="text" class="form-control required c_color" name="category_color" placeholder="Select Color" required="" id="category_color" value="{{ $category->c_color }}">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input form-control" name="category_image" id="customFile" accept="image/*" alt="Image">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input form-control" name="category_trans_image" id="customFileTrans" accept="image/*" alt="Image">
                                        ...
                                        <div class="col-sm-12 form-group">
                                            ...
                                            <label class="custom-switch mt-2">
                                                <input type="checkbox" name="c_is_eco" class="custom-switch-input" @if($category->c_is_eco==1) checked @endif>

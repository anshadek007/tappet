    ...
    <td>
        <table  align="left" cellpadding="10" cellspacing="0"  width="100%" style="padding: 40px 25px 50px 25px; max-width:600px;border-spacing:0px;border-width:medium;border-style:none;border-top:1px solid #efefef;border-bottom: 1px solid #efefef; color: #4f4f4f; font-size: 14px;line-height:22px;">
            <tbody>
                ...
                <tr>
                    <td>You've received {{$tour_name}} tour invitation mail from {{$invitation_from}}</td>
                </tr>
                ...
                <tr style="text-align: center">
                    <td style="text-align: center"><a href="https://www.apple.com/in/ios/app-store/?tour_invitation_token={{$invitation_token}}"><img src="{{asset('/public/assets/images/app-store.png')}}" width="100" height="100" ></a></td>
                </tr>
                <tr style="text-align: center">
                    <td style="text-align: center"><a href="https://play.google.com/store?hl=en&tour_invitation_token={{$invitation_token}}"><img src="{{asset('/public/assets/images/play-store.png')}}" width="100" height="100" ></a></td>
                </tr>
                <tr>
                    <td></td>
                </tr>

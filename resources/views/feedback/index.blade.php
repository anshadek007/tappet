...
$module_permission = !empty($module_permissions['feedback']) ? $module_permissions['feedback'] : array();
@endphp
                            ...
                            <div class="accordion">
                                ...
                                <div class="accordion-body collapse" id="panel-body-1" data-parent="#accordion">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <input type="text" placeholder="Feedback" name="content" id="content" class="form-control">
                                            </div>
                                        </div>
...
var controller_url = "{{route('feedback.index')}}";
var module_permission = {!! json_encode(array_values($module_permission)) !!};
</script>

<!-- Page Specific JS File -->
<script src="{{asset("public/assets/pages-js/feedback/index.js")}}"></script>
@endsection
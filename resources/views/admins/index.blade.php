...
$module_permission = !empty($module_permissions['admins']) ? $module_permissions['admins'] : array();
@endphp
    ...
    <section class="section">
        <div class="section-header">
            <div class="col-lg-12">
                ...
                <a href="{{route("admins.create")}}" class="float-right btn btn-primary">Add New Admin</a>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
...
<script src="{{asset("public/assets/pages-js/admins/index.js")}}"></script>
@endsection
...
$module_permission = !empty($module_permissions['terms']) ? $module_permissions['terms'] : array();
@endphp
    ...
    <section class="section">
        <div class="section-header">
            <div class="col-lg-12">
                ...
                <a href="{{route("terms.create")}}" class="float-right btn btn-primary">Add New</a>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
...
<script src="{{asset("public/assets/pages-js/terms/index.js")}}"></script>
@endsection
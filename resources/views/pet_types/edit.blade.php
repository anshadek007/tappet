            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form class="" id="add_custom_form" novalidate="" action="{{route("pet_types.update",$pet_type->pt_id)}}" enctype="multipart/form-data" method="POST">
                            @csrf
                                ...
                                <div class="col-sm-12">
                                    <div class="row">
                                        <div class="col-sm-12 form-group">
                                            <img alt="img" src="{{$pet_type->pt_image}}" class="rounded-circle mr-1" height="100" width="100">
                                        </div>

                                        <div class="col-sm-6 form-group">
                                            <label for="pet_type_name">Pet Type Name</label>
                                            <input type="text" value="{{ $pet_type->pt_name }}" placeholder="Enter pet type Name" name="pet_type_name" class="form-control required" required="" maxlength="100" id="pet_type_name">
                            ...
                            <div class="card-footer text-right">
                                ...
                                <a href="{{route("pet_types.index")}}" class="btn btn-light">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
...
<script type="text/javascript">
    var controller_url = "{{route('pet_types.index')}}";
</script>
...
<script src="{{asset("public/assets/pages-js/pet_types/add_edit.js")}}"></script>
@endsection
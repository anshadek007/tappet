...
$module_permission = !empty($module_permissions['pet_types']) ? $module_permissions['pet_types'] : array();
@endphp
    ...
    <section class="section">
        <div class="section-header">
            <div class="col-lg-12">
                ...
                @endphp
                <h1>Pet Types</h1>
                <a href="{{route("pet_types.create")}}" class="float-right btn btn-primary">Add New</a>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
...
<script src="{{asset("public/assets/pages-js/pet_types/index.js")}}"></script>
@endsection
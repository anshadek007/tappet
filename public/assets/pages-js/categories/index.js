...
function get_all_data() {
    ...
    jQuery(data_table).dataTable({
        ...
        ajax: {
            ...
            "type": "POST",
            "async": false,
            "data": {'_token': token, 'name': name, 'status': status},
        },
...
jQuery(document).ready(function () {
    ...
    jQuery(document).on('click', '.delete_data_button', function () {
        ...
        if (!isNaN(id)) {
            swal({
                ...
                text: 'Once deleted, you will not be able to recover this data and this action will remove tours binded with this City.',
                icon: 'warning',
                buttons: true,
                dangerMode: true,
    ...
    jQuery(document).on('blur', '.category_order', function () {
        var category_order = jQuery(this).val();
        var id = jQuery(this).attr('data-id');
        var attr_value = jQuery(this).attr('data-value');
        var attr_id = jQuery(this).attr('id');
        if (!isNaN(id) && !isNaN(category_order) && category_order != "" && category_order != null) {
            jQuery.ajax({
                "url": controller_url + '/change_order',
                type: "POST",
                data: {
                    'id': id,

...
function get_all_data() {
    ...
    jQuery(data_table).dataTable({
        ...
        ajax: {
            ...
            "type": "POST",
            "async": false,
            "data": {'_token': token, 'name': name,'email': email,'mobile_number': mobile_number, 'status': status},
        },
...
jQuery(document).ready(function () {
    ...
    jQuery(document).on('click', '.delete_data_button', function () {
        ...
        if (!isNaN(id)) {
            swal({
                title: 'Are you sure you want to delete this contactus record?',
                text: 'Once data is deleted then its never recoverable.',
                icon: 'warning',
                buttons: true,
                dangerMode: true,
